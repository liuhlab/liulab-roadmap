...
- [LLM Fundamentals](https://www.aihero.dev/llm-fundamentals)（英文）：浏览器里就能交互着学的短教程，讲 system prompt 到底起什么作用、模型为什么是用数字思考的、上下文塞太满为什么反而坏事。开始使唤 agent 之前花半小时过一遍，后面很多迷惑会自己解开。
