...
- [LLM Fundamentals](https://www.aihero.dev/llm-fundamentals): a short interactive tutorial that runs entirely in the browser, covering what a system prompt really does, why the model thinks in numbers rather than words, and why overstuffing the context window backfires. Half an hour here, before you start driving an agent, clears up a lot of later confusion.
